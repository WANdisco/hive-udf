 ...
 * Changes made to improve performance a bit and split implementations.
 */

@Description(name = "approx_distinct_kmv",
        value = "_FUNC_(x) - Adds values from x to new K-Minimum Values Estimator, " +
                "\nReturns a long cardinality",
        extended =  "Example:" +
                "\n> SELECT approx_distinct_kmv(values) FROM src; -- defaults to KMV with b=5000")
public class UDAFCntKMV extends AbstractGenericUDAFResolver { //implements GenericUDAFResolver2 {
    ...
    public static class CardinalityEstimatorEvaluator extends GenericUDAFEvaluator {
        ...
        public void iterate(AggregationBuffer aggregationBuffer, Object[] parameters) throws HiveException {
            ...
            if (inputPrimitiveOI != null) {
                ...
                if (ceb.cardinalityEstimator == null) {
                  ceb.cardinalityEstimator = new LinearCounting.Builder(5000).build();
                }
              ...
              ICardinality that = new LinearCounting(lb.getWritableObject().getBytes());
      ...
      byte[] tb = {1};
        ...
        public void merge(AggregationBuffer aggregationBuffer, Object partial) throws HiveException {
            ...
            ICardinality partialEstimator = new LinearCounting(partialBytes.getBytes());
        ...
        public Object terminate(AggregationBuffer aggregationBuffer) throws HiveException {
            ...
            try {
                ...
                long cardinality = ceb.cardinalityEstimator instanceof LinearCounting
                        ? ((LinearCounting) ceb.cardinalityEstimator).cardinality()
