...
@Description(name = "approx_distinct_lc", value = "_FUNC_(x) - Adds values from x to new LynearCounting Estimator, "
...
public class UDAFCntLC extends AbstractGenericUDAFResolver { // implements
