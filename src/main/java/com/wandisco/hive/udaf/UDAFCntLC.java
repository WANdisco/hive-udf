...
@Description(name = "approx_distinct_lc",
        value = "_FUNC_(x) - Adds values from x to new LynearCounting Estimator, " +
        ...
        public void iterate(AggregationBuffer aggregationBuffer, Object[] parameters) throws HiveException {
            ...
            if (inputPrimitiveOI != null) {
                ...
                if (ceb.cardinalityEstimator == null) {
                  ceb.cardinalityEstimator = new LinearCounting.Builder(1000000).build();
                }
